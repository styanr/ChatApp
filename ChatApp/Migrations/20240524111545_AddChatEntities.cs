...
namespace ChatApp.Migrations
{
    ...
    public partial class AddChatEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "GroupChatRoomUsers",
                columns: table => new
                {
                    GroupChatRoomId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UsersId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupChatRoomUsers", x => new { x.GroupChatRoomId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_GroupChatRoomUsers_ChatRooms_GroupChatRoomId",
